      ...
      <div class="max-width">
         ...
         <div class="premium-content">
            <div class="column left">
               <img src="<?php echo URL; ?>app/sts/assets/images/home_prem/premium_v5.jpg" alt="Serviço premium">
            </div>
            <div class="column right">
               <div class="text"><?php echo $prem_subtitle; ?></div>
               <p><?php echo $prem_desc; ?></p>
